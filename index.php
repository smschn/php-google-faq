<?php
        $faq = [
            ...
            [
                ...
                'question2' => "Stabilire il paese associato al tuo account",
                'answer2' => "Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno.
        ...
        <div class="container widthMargin">
            ...
            <?php
                foreach($faq as $singleFaq) {
                    ...
                    $paragraphs = explode(PHP_EOL, $singleFaq['answer']);
                    foreach($paragraphs as $paragraph) {
                        echo '<p>' . $paragraph . '</p>';
                    }
                    if ($singleFaq['question2'] && $singleFaq['answer2']) {
                        echo '<h4>' . $singleFaq['question2'] . '</h4>';
                        echo '<p>' . $singleFaq['answer2'] . '</p>';
                    }
                }
            ?>
